...
import torch
from exp.exp_long_term_forecasting_text_integrated import Exp_Long_Term_Forecast
    ...
    if args.is_training:
        for ii in range(args.itr):
            if args.use_text_integrated:
                version_suffix = f"vtext_integrated_{args.text_injection_mode}"
            else:
            ...
            setting = '{}_{}_{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_expand{}_dc{}_fc{}_eb{}_dt{}_{}_{}_llm{}_{}{}'.format(
                args.task_name,
                args.model_id,
                args.model,
                args.data,
