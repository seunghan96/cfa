...
class Model(nn.Module):
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec, text_context=None):
        ...
        # enc (first fusion inside enc_embedding when text_context and first-*)
        ...
        # dec
        seasonal_part, trend_part = self.decoder(dec_out, enc_out, x_mask=None, cross_mask=None, trend=trend_init, text_context=enc_text)
        # final
        dec_out = trend_part + seasonal_part

        # Last fusion: inject into dec_out [B, label_len+pred_len, c_out]
